                    ...
                    <div className="relative flex items-center justify-between h-16">
                        <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                            ...
                            <Disclosure.Button className="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                                ...
                                {open ? (
                                    <svg xmlns="http://www.w3.org/2000/svg" className="block h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div className="flex items-center justifu-center space-x-4">
                                    {navigation.map(item => (
                                        <a
                                            ...
                                            className={classNames(item.current ? 'bg-green-400 text-white dark:bg-gray-100 dark:text-gray-700 font-bold' : 'text-gray-700 dark:text-gray-300 hover:bg-green-400 hover:text-white dark:hover:bg-white dark:hover:text-black', 'px-3 py-2 rounded text-sm cursor-pointer')}
                                        >
                                            {item.name}
                                        </a>
                                    ))}
